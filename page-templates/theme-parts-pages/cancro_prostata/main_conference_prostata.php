      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            ...
            <figure class="side-image"> <img src="<?php the_field('prostata_imagem')?>" alt="Image"> </figure>
            <!-- end side-image --> 
				   </div>
			  <!-- end data-scroll -->
          </div>
          ...
          <div class="col-lg-6">
            ...
            <div class="side-content right light">
              <h3><?php the_field('prostata_titulo')?></h3>
              <p><?php the_field('prostata_conteudo')?></p>
                
              <div class="countdown light right" data-event="<?php the_field('prostata_data')?>" id="js-countdown">
              ...
              <!-- end countdown --> 
              <a href="<?php the_field('prostata_botao_link')?>" class="custom-button light"> <span class="circle" aria-hidden="true"> <span class="icon arrow"></span> </span> <span class="button-text"><?php the_field('prostata_botao')?></span></a> </div>
            <!-- end side-content -->
				    </div>
			  <!-- end data-scroll -->
          </div>
