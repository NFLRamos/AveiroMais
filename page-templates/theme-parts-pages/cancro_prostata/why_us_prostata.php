        ...
        <div class="row">
          <div class="col-lg-7">
            ...
            <div class="side-content left">
              <h6><?php the_field('prostata_sub_titulo')?></h6>
              <h2><?php the_field('prostata_titulo_why')?></h2>
              <p><?php the_field('prostata_content')?></p>
              <a href="<?php the_field('prostata_link_botao')?>" class="custom-button"> <span class="circle" aria-hidden="true"> <span class="icon arrow"></span> </span> <span class="button-text"><?php the_field('prostata_texto_botao')?></span></a> </div>
            <!-- end side-content --> 
				     </div>
			  <!-- end data-scroll -->
          </div>
          ...
          <div class="col-xl-3 col-lg-4 offset-xl-2 offset-lg-1">
            ...
            <div class="color-icon-box" data-background="#388B7C">
              ...
              <!-- end inner-bg -->
              <figure> <img src="<?php the_field('prostata_box_1')?>" alt="Image"> </figure>
              <?php the_field('prostata_content_card_1')?>
            </div>
            <!-- end color-icon-box -->
				    </div>
			  <!-- end data-scroll -->
            ...
            <div class="color-icon-box" data-background="#151517">
              ...
              <!-- end inner-bg -->
              <figure> <img src="<?php the_field('prostata_box_2','option')?>" alt="Image"> </figure>
              <?php the_field('prostata_content_card_2')?>
            </div>
            <!-- end color-icon-box --> 
				      </div>
			  <!-- end data-scroll -->
          ...
          <div class="col-xl-3 col-lg-4 offset-xl-6 offset-lg-4">
            ...
            <div class="color-icon-box" data-background="#334AC1">
              ...
              <!-- end inner-bg -->
              <figure> <img src="<?php the_field('prostata_box_3')?>" alt="Image"> </figure>
              <?php the_field('prostata_content_card_3')?>
            </div>
            <!-- end color-icon-box --> 
				   </div>
			  <!-- end data-scroll -->
