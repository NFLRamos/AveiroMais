...
if ( ! function_exists( 'aveiromais_adjust_body_class' ) ) {
	 ...
	 */
	function aveiromais_adjust_body_class( $classes ) {
...
if ( ! function_exists( 'aveiromais_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function aveiromais_slbd_count_widgets( $sidebar_id ) {
...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'aveiromais' ),
		__( 'Previous', 'aveiromais' ),
		__( 'Next', 'aveiromais' ),
		__( 'About:', 'aveiromais' ),
		__( 'Profile', 'aveiromais' ),
		__( 'Posts by', 'aveiromais' ),
		__( 'Permanent Link:', 'aveiromais' ),
		__( 'in', 'aveiromais' ),
		__( 'Edit', 'aveiromais' ),
	);
}
