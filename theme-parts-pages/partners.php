<section class="content-section no-bottom-spacing">
		<div class="section-bg" data-background="<?php echo get_template_directory_uri(); ?>/assets/section-bg02.png" data-scroll data-scroll-speed="1"></div>
		<!-- end section-bg -->
      <div class="container">
        <div class="row justify-content-center text-center">
          ...
          <?php 
            $terms = get_terms( array(
                'taxonomy' => 'typeofpartner',
                'hide_empty' => false,
            ) );

            foreach($terms as $t){ ?>
            <div class="col-12"> <strong class="sponsor-title"><?php echo $t->name; ?></strong> </div>
            <?php
